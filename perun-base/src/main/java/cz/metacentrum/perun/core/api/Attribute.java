...
public class Attribute extends AttributeDefinition implements Serializable {
	...
	public Attribute(Attribute attribute) {
		super(attribute.getId(), attribute.getCreatedAt(), attribute.getCreatedBy(), attribute.getModifiedAt(), attribute.getModifiedBy(),
				attribute.getCreatedByUid(), attribute.getModifiedByUid(), attribute.getFriendlyName(), attribute.getNamespace(),
				attribute.getType(), attribute.getWritable(), attribute.getDisplayName());
		this.value = attribute.getValue();
		this.valueCreatedAt = attribute.getValueCreatedAt();
		this.valueCreatedBy = attribute.getCreatedBy();
